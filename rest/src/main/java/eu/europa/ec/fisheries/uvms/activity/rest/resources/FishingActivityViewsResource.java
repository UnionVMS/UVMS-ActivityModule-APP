...
public class FishingActivityViewsResource extends UnionVMSResource {
    ...
    public Response getActivityArrivalView(@Context HttpServletRequest request,
        ...
        return createActivityView(scopeName, roleName, activityViewDto.getActivityId(), activityViewDto.getTripId(), activityViewDto.getReportId(), request, ActivityViewEnum.ARRIVAL);
    }
    ...
    public Response getActivityLandingView(@Context HttpServletRequest request,
                                           ...
                                           @HeaderParam("roleName") String roleName,
                                           ActivityViewDto activityViewDto) throws ServiceException {
        return createActivityView(scopeName, roleName, activityViewDto.getActivityId(), activityViewDto.getTripId(), activityViewDto.getReportId(), request, ActivityViewEnum.LANDING);
    }
    ...
    public Response getDiscardAtSeaView(@Context HttpServletRequest request,
                                        ...
                                        @HeaderParam("roleName") String roleName,
                                        ActivityViewDto activityViewDto) throws ServiceException {
        return createActivityView(scopeName, roleName, activityViewDto.getActivityId(), activityViewDto.getTripId(), activityViewDto.getReportId(), request, ActivityViewEnum.DISCARD_AT_SEA);
    }
    ...
    public Response getActivityDepartureView(@Context HttpServletRequest request,
                                             ...
                                             @HeaderParam("roleName") String roleName,
                                             ActivityViewDto activityViewDto) throws ServiceException {
        return createActivityView(scopeName, roleName, activityViewDto.getActivityId(), activityViewDto.getTripId(), activityViewDto.getReportId(), request, ActivityViewEnum.DEPARTURE);
    }
    ...
    public Response getActivityNotificationOfArrivalView(@Context HttpServletRequest request,
                                                         ...
                                                         @HeaderParam("roleName") String roleName,
                                                         ActivityViewDto activityViewDto) throws ServiceException {
        return createActivityView(scopeName, roleName, activityViewDto.getActivityId(), activityViewDto.getTripId(), activityViewDto.getReportId(), request, ActivityViewEnum.PRIOR_NOTIFICATION_OF_ARRIVAL);
    }
    ...
    public Response getActivityAreaEntryView(@Context HttpServletRequest request,
                                             ...
                                             @HeaderParam("roleName") String roleName,
                                             ActivityViewDto activityViewDto) throws ServiceException {
        return createActivityView(scopeName, roleName, activityViewDto.getActivityId(), activityViewDto.getTripId(), activityViewDto.getReportId(), request, ActivityViewEnum.AREA_ENTRY);
    }
    ...
    public Response getActivityAreaExitView(@Context HttpServletRequest request,
                                            ...
                                            @HeaderParam("roleName") String roleName,
                                            ActivityViewDto activityViewDto) throws ServiceException {
        return createActivityView(scopeName, roleName, activityViewDto.getActivityId(), activityViewDto.getTripId(), activityViewDto.getReportId(), request, ActivityViewEnum.AREA_EXIT);
    }
    ...
    public Response getGearShotAndRetrievalView(@Context HttpServletRequest request,
                                                ...
                                                @HeaderParam("roleName") String roleName,
                                                ActivityViewDto activityViewDto) throws ServiceException {
        return createActivityView(scopeName, roleName, activityViewDto.getActivityId(), activityViewDto.getTripId(), activityViewDto.getReportId(), request, ActivityViewEnum.GEAR_SHOT_RETRIEVAL);
    }
    ...
    public Response getTranshipmentView(@Context HttpServletRequest request,
                                        ...
                                        @HeaderParam("roleName") String roleName,
                                        ActivityViewDto activityViewDto) throws ServiceException {
        return createActivityView(scopeName, roleName, activityViewDto.getActivityId(), activityViewDto.getTripId(), activityViewDto.getReportId(), request, ActivityViewEnum.TRANSSHIPMENT);
    }
    ...
    public Response getFishingOperationView(@Context HttpServletRequest request,
                                            ...
                                            @HeaderParam("roleName") String roleName,
                                            ActivityViewDto activityViewDto) throws ServiceException {
        return createActivityView(scopeName, roleName, activityViewDto.getActivityId(), activityViewDto.getTripId(), activityViewDto.getReportId(), request, ActivityViewEnum.FISHING_OPERATION);
    }
    ...
    public Response getRelocationView(@Context HttpServletRequest request,
                                      ...
                                      @HeaderParam("roleName") String roleName,
                                      ActivityViewDto activityViewDto) throws ServiceException {
        return createActivityView(scopeName, roleName, activityViewDto.getActivityId(), activityViewDto.getTripId(), activityViewDto.getReportId(), request, ActivityViewEnum.RELOCATION);
    }
    ...
    public Response getJointFishingOperationView(@Context HttpServletRequest request,
                                                 ...
                                                 @HeaderParam("roleName") String roleName,
                                                 ActivityViewDto activityViewDto) throws ServiceException {
        return createActivityView(scopeName, roleName, activityViewDto.getActivityId(), activityViewDto.getTripId(), activityViewDto.getReportId(), request, ActivityViewEnum.JOINT_FISHING_OPERATIONS);
    }
     ...
     */
    private Response createActivityView(String scopeName, String roleName, Integer activityId, String tripId, Integer reportId, HttpServletRequest request, ActivityViewEnum view) throws ServiceException {
        ...
        return createSuccessResponse(activityService.getFishingActivityForView(activityId, tripId, reportId, datasets, view));
    }
}
