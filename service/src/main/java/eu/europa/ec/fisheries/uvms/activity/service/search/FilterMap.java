...
public class FilterMap {
    ...
    public void populateFilterMappings() {
        ...
        filterMappings.put(SearchFilter.TRIP_ID, new FilterDetails(StringUtils.SPACE + FISHING_TRIP_TABLE_ALIAS, "fishingTrip.tripId =:" + TRIP_ID + StringUtils.SPACE));
        filterMappings.put(SearchFilter.FISHING_TRIP_SCHEME_ID, new FilterDetails(StringUtils.SPACE + FISHING_TRIP_TABLE_ALIAS, "fishingTrip.tripSchemeId =:" + TRIP_SCHEME_ID + StringUtils.SPACE));
    }
