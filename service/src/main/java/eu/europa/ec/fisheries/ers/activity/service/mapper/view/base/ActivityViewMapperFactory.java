...
import eu.europa.ec.fisheries.ers.activity.service.mapper.view.ActivityAreaEntryViewMapper;
import eu.europa.ec.fisheries.ers.activity.service.mapper.view.ActivityAreaExitViewMapper;
import eu.europa.ec.fisheries.ers.activity.service.mapper.view.ActivityArrivalViewMapper;
import eu.europa.ec.fisheries.ers.activity.service.mapper.view.ActivityDepartureViewMapper;
import eu.europa.ec.fisheries.ers.activity.service.mapper.view.ActivityLandingViewMapper;
import eu.europa.ec.fisheries.ers.activity.service.mapper.view.ActivityNotificationOfArrivalViewMapper;
import eu.europa.ec.fisheries.ers.activity.service.mapper.view.ActivityRelocationViewMapper;
import eu.europa.ec.fisheries.ers.activity.service.mapper.view.ActivityTranshipmentViewMapper;
import eu.europa.ec.fisheries.ers.activity.service.mapper.view.DiscardViewMapper;
import eu.europa.ec.fisheries.ers.activity.service.mapper.view.FishingOperationViewMapper;
import eu.europa.ec.fisheries.ers.activity.service.mapper.view.GearShotRetrievalTileMapper;
import eu.europa.ec.fisheries.ers.activity.service.mapper.view.JointFishingOperationViewMapper;
    ...
    public static BaseActivityViewMapper getMapperForView(ActivityViewEnum view) throws ServiceException {
        ...
        switch (view) {
            ...
            case DISCARD_AT_SEA:
                ...
                break;
            case RELOCATION:
                mapper = new ActivityRelocationViewMapper();
                break;
