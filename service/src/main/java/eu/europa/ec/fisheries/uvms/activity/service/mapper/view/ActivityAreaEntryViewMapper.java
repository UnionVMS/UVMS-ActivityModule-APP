...
public abstract class ActivityAreaEntryViewMapper extends BaseActivityViewMapper {
    ...
    @Mappings({
            ...
            @Mapping(target = "areas", expression = "java(getSortedAreas(faEntity, new eu.europa.ec.fisheries.uvms.activity.service.mapper.view.base.FluxLocationDTOSchemeIdComparator()))"),
