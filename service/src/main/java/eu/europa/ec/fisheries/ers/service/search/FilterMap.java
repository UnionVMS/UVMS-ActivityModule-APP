...
public class FilterMap {
   ...
   public static final String FLUX_PARTY_TABLE_ALIAS = " flux.fluxParty fp  ";
    ...
    private static void populateFilterMappings(){
        ...
        filterMappings.put(Filters.QUNTITY_MIN,new FilterDetails(FA_CATCH_TABLE_ALIAS+" JOIN FETCH faCatch.aapProcesses aprocess JOIN FETCH aprocess.aapProducts aprod"," (faCatch.calculated_weight_measure  BETWEEN :"+QUNTITY_MIN ));
