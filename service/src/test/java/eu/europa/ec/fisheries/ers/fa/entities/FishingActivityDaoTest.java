...
private FishingActivityDao dao=new FishingActivityDao(em);
 ...
 @Before   
  public void prepare(){
      Operation operation = sequenceOf(DELETE_ALL,INSERT_ERS_FLUX_PARTY_DATA,INSERT_ERS_FLUX_PARTY_IDENTIFIER_DATA,INSERT_ERS_FLUX_REPORT_DOCUMENT_DATA,INSERT_ERS_FLUX_REPORT_IDENTIFIER_DATA,INSERT_ERS_VESSEL_TRANSPORT_MEANS_DATA,INSERT_CONTACT_PERSON,INSERT_CONTACT_PARTY,
