...
public class FaQueryFactoryTest {
    ...
    @Test
    public void createFaQueryForVesselId() {
        FAQuery query = FaQueryFactory.createFaQueryForVesselId("submitter", "12345678", "CFR", true, "2019-01-01T10:00:00", "2019-02-01T10:00:00");
        Assert.assertNotNull(query);
        Assert.assertNotNull(query.getID());
        Assert.assertNotNull(query.getSubmittedDateTime());
    ...
    public void createFaQueryWithInvalidDates() {
        FaQueryFactory.createFaQueryForVesselId("submitter", "12345678", "CFR", true, "date", "date");
    }
}